...
# Add Depth package to sys.path
BASE_DIR = Path(__file__).resolve().parent
sys.path.append(str(BASE_DIR))
sys.path.append(str(BASE_DIR / "Depth"))
...
RFDETR_CHECKPOINT = os.getenv("RFDETR_CHECKPOINT", str(BASE_DIR / "best_saved_model" / "checkpoint_best_ema.pth"))
